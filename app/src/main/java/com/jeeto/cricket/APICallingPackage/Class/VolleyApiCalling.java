package com.jeeto.cricket.APICallingPackage.Class;
...
import com.jeeto.cricket.APICallingPackage.Interface.ServerResponseListner;
import com.jeeto.cricket.APICallingPackage.Interface.VolleyRestClient;
import com.jeeto.cricket.AppConfig;
...
public class VolleyApiCalling extends Activity implements VolleyRestClient {
    ...
    public void callRestApi(String url, final JSONObject jsonObject, final Context mContext,
        ...
        if (Validations.isNetworkAvailable(mContext)) {
            ...
            stringRequest.setRetryPolicy(new DefaultRetryPolicy(75000,
