...
public class ActivityMyTransactionBindingImpl extends ActivityMyTransactionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.RV_MyTransactions, 3);
    ...
    public ActivityMyTransactionBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityMyTransactionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
