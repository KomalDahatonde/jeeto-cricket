...
public class ActivityMyAccountBindingImpl extends ActivityMyAccountBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_TotalBalanceHead, 2);
        sViewsWithIds.put(R.id.tv_WalletBalance, 3);
        sViewsWithIds.put(R.id.tv_TotalBalance, 4);
        sViewsWithIds.put(R.id.tv_AddBalance, 5);
        sViewsWithIds.put(R.id.tv_DepositeHead, 6);
        sViewsWithIds.put(R.id.tv_DepositedAmount, 7);
        sViewsWithIds.put(R.id.im_DepositeInfo, 8);
        sViewsWithIds.put(R.id.tv_WinningsHead, 9);
        sViewsWithIds.put(R.id.tv_WinningAmount, 10);
        sViewsWithIds.put(R.id.im_WinningInfo, 11);
        sViewsWithIds.put(R.id.tv_BonusHead, 12);
        sViewsWithIds.put(R.id.tv_BonusAmount, 13);
        sViewsWithIds.put(R.id.im_BonusInfo, 14);
        sViewsWithIds.put(R.id.tv_Withdraw, 15);
        sViewsWithIds.put(R.id.RL_MyRecentTransactions, 16);
        sViewsWithIds.put(R.id.RL_ManagePayments, 17);
        sViewsWithIds.put(R.id.tv_ManagePayment, 18);
        sViewsWithIds.put(R.id.tv_PanHead, 19);
        sViewsWithIds.put(R.id.tv_UploadPan, 20);
        sViewsWithIds.put(R.id.im_PanVerified, 21);
        sViewsWithIds.put(R.id.tv_AadhaarHead, 22);
        sViewsWithIds.put(R.id.tv_UploadAadhaar, 23);
        sViewsWithIds.put(R.id.im_AadhaarVerified, 24);
    }
    // views
    @NonNull
