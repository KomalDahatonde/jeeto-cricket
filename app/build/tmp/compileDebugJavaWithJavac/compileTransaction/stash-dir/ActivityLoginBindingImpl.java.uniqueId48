...
public class ActivityLoginBindingImpl extends ActivityLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_SignUpText, 1);
        sViewsWithIds.put(R.id.fb_login_button, 2);
        sViewsWithIds.put(R.id.btn_sign_in, 3);
        sViewsWithIds.put(R.id.input_loginEmail, 4);
        sViewsWithIds.put(R.id.et_EmailMobile, 5);
        sViewsWithIds.put(R.id.input_loginPassword, 6);
        sViewsWithIds.put(R.id.et_Password, 7);
        sViewsWithIds.put(R.id.tv_ForgotPassword, 8);
