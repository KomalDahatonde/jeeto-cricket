...
public class ActivityPaymentConfirmationBindingImpl extends ActivityPaymentConfirmationBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_WalletBalance, 2);
        sViewsWithIds.put(R.id.tv_ConfirmationEntryFee, 3);
        sViewsWithIds.put(R.id.tv_ConfirmationBonus, 4);
        sViewsWithIds.put(R.id.tv_BonusPercentage, 5);
        sViewsWithIds.put(R.id.tv_ConfirmationToPay, 6);
        sViewsWithIds.put(R.id.tv_ConfirmationJoinContest, 7);
    }
    // views
    @NonNull
    ...
    public ActivityPaymentConfirmationBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivityPaymentConfirmationBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
