...
public class ActivityJoinContestBindingImpl extends ActivityJoinContestBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.Rv_JoinMyTeamList, 4);
        sViewsWithIds.put(R.id.tv_NoDataAvailable, 5);
        sViewsWithIds.put(R.id.RL_BottomMyTeam, 6);
        sViewsWithIds.put(R.id.tv_JoinCreateTeam, 7);
    }
    // views
    @NonNull
    ...
    public ActivityJoinContestBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivityJoinContestBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
