...
public class ActivityMyLiveContestDetailsBindingImpl extends ActivityMyLiveContestDetailsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.RL_ResultMain, 4);
        sViewsWithIds.put(R.id.LL_ScoreCard, 5);
        sViewsWithIds.put(R.id.tv_TeamOneName, 6);
        sViewsWithIds.put(R.id.tv_TeamOneScore, 7);
        sViewsWithIds.put(R.id.tv_TeamOneOver, 8);
        sViewsWithIds.put(R.id.tv_TeamTwoName, 9);
        sViewsWithIds.put(R.id.tv_TeamTwoScore, 10);
        sViewsWithIds.put(R.id.tv_TeamTwoOver, 11);
        sViewsWithIds.put(R.id.tv_StatusNote, 12);
        sViewsWithIds.put(R.id.LL_ContestTop, 13);
        sViewsWithIds.put(R.id.tv_TotalPrice, 14);
        sViewsWithIds.put(R.id.tv_WinnersCount, 15);
        sViewsWithIds.put(R.id.tv_EntryFees, 16);
        sViewsWithIds.put(R.id.tv_JoinedWithTeamTop, 17);
        sViewsWithIds.put(R.id.RL_LeaderboardList, 18);
        sViewsWithIds.put(R.id.tv_TotalJoinedTeamCount, 19);
        sViewsWithIds.put(R.id.Rv_MyLiveLeaderboard, 20);
    }
    // views
    @NonNull
    ...
    public ActivityMyLiveContestDetailsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 21, sIncludes, sViewsWithIds));
    }
    private ActivityMyLiveContestDetailsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
