...
public class ActivityEnterInviteCodeContestBindingImpl extends ActivityEnterInviteCodeContestBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(1, 
            ...
            new int[] {3},
            new int[] {com.jeeto.cricket.R.layout.adapter_contest_list});
    ...
    private ActivityEnterInviteCodeContestBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (com.jeeto.cricket.databinding.AdapterContestListBinding) bindings[3]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeInclAdapter((com.jeeto.cricket.databinding.AdapterContestListBinding) object, fieldId);
            case 1 :
                return onChangeHead((com.jeeto.cricket.databinding.ActivityMainheaderBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeInclAdapter(com.jeeto.cricket.databinding.AdapterContestListBinding InclAdapter, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
