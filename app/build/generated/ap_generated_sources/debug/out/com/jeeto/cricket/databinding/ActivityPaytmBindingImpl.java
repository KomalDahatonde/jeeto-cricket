...
public class ActivityPaytmBindingImpl extends ActivityPaytmBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_TxDetails, 2);
        sViewsWithIds.put(R.id.tv_Proceed, 3);
    }
    // views
    @NonNull
    ...
    public ActivityPaytmBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ActivityPaytmBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
