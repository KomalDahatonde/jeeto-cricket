...
public class ActivityPaymentOptionBindingImpl extends ActivityPaymentOptionBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_PaymentFinalAmount, 2);
        sViewsWithIds.put(R.id.RL_PaytmPayment, 3);
        sViewsWithIds.put(R.id.im_InviteFriends, 4);
        sViewsWithIds.put(R.id.tv_InviteFriend, 5);
        sViewsWithIds.put(R.id.im_arrow1, 6);
        sViewsWithIds.put(R.id.RL_PayUMoneyPayment, 7);
        sViewsWithIds.put(R.id.im_PayUMoney, 8);
        sViewsWithIds.put(R.id.im_arrow2, 9);
        sViewsWithIds.put(R.id.RL_TrakNPayPayment, 10);
        sViewsWithIds.put(R.id.im_TraknPay, 11);
        sViewsWithIds.put(R.id.im_arrow3, 12);
        sViewsWithIds.put(R.id.RL_CashFree, 13);
        sViewsWithIds.put(R.id.im_cashfree, 14);
        sViewsWithIds.put(R.id.im_arrow4, 15);
    }
    // views
    @NonNull
