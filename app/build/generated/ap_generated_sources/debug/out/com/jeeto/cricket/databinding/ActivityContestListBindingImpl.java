...
public class ActivityContestListBindingImpl extends ActivityContestListBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.RL_CreateContest, 3);
        sViewsWithIds.put(R.id.tv_EnterContestCode, 4);
        sViewsWithIds.put(R.id.tv_CreateContest, 5);
        sViewsWithIds.put(R.id.swipeRefreshLayout, 6);
        sViewsWithIds.put(R.id.Rv_ContestList, 7);
        sViewsWithIds.put(R.id.tv_NoDataAvailable, 8);
        sViewsWithIds.put(R.id.RL_BottomMyTeam, 9);
        sViewsWithIds.put(R.id.tv_MyTeam, 10);
    }
    // views
    @NonNull
    ...
    public ActivityContestListBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private ActivityContestListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
