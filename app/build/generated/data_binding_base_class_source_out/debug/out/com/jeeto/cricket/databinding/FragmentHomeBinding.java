...
public abstract class FragmentHomeBinding extends ViewDataBinding {
  @NonNull
  public final TabLayout FragmentTab;

  @NonNull
  public final RelativeLayout RLHomeFRLayout;

  @NonNull
  public final ViewPager viewpager;

  protected FragmentHomeBinding(Object _bindingComponent, View _root, int _localFieldCount,
      TabLayout FragmentTab, RelativeLayout RLHomeFRLayout, ViewPager viewpager) {
    super(_bindingComponent, _root, _localFieldCount);
    this.FragmentTab = FragmentTab;
    this.RLHomeFRLayout = RLHomeFRLayout;
